...
private void CheckBoxRepeater_ItemDataBound(Object Sender, RepeaterItemEventArgs e){
...
<table cellspacing="0" cellpadding="5" class="lrbBorders" width="750" id="ManageUsersTable">
    <tr>
        <td class="callOutStyle"><h1 class="callOutHeaderStyle"><asp:literal runat="server" text="<%$ Resources:SearchForUsers %>"/></h1></td>
    </tr>
    <tr >
...
<table cellspacing="0" cellpadding="0" border="0" id="hook" width="750">
    ...
    <tr align="left" valign="top">
        <td width="62%" height="100%" class="lbBorders">
            <asp:gridview runat="server" id="DataGrid" width="100%" cellspacing="0" cellpadding="5" border="0" autogeneratecolumns="False" allowpaging="true" pagesize="7" onpageindexchanging="IndexChanged" UseAccessibleHeader="true" OnRowDataBound="DataGrid_RowDataBound">
            ...
            <itemtemplate>
            <asp:label runat="server" AssociatedControlID="CheckBox1" id="UserNameLink" forecolor='black' text='<%#DataBinder.Eval(Container.DataItem, "UserName")%>'/>
            </itemtemplate>
            </asp:templatefield>
            ...
            <asp:placeholder runat="server" id="RolePlaceHolder">
                <table borderwidth="1px" cellpadding="5" cellspacing="0" height="100%" width="100%">
                    <tr class="callOutStyle">
                        <td valign="center"><h1 class="callOutHeaderStyle"><asp:literal runat="server" text="<%$ Resources:Roles %>"/></h1></td>
                    </tr>
                    <tr class="userDetailsWithFontSize" valign="top">
                        <td class="lrbBorders" height="100%" >
                            ...
                            <itemtemplate>
                            <asp:checkBox runat="server" id="CheckBox2" autopostback="true" oncheckedchanged="RoleMembershipChanged" text='<%# Container.DataItem.ToString()%>' checked='<%# (bool)CallWebAdminHelperMethod(false, "IsUserInRole", new object[] {CurrentUser, Container.DataItem.ToString()}, new Type[] {typeof(string),typeof(string)}) %>'/>
                            <br/>
                            </itemtemplate>
                            </asp:repeater>
                            </asp:view>

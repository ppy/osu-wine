...
private void ProviderListGridView_DataBound(object sender, GridViewRowEventArgs e) {
    ...
    if (row.RowType == DataControlRowType.DataRow) {
        ...
        if (radioButton != null) {
            if(row.RowIndex == ProviderListGridView.SelectedIndex) {
                radioButton.Checked = true;
            }
            radioButton.InputAttributes.Add("title", (string)GetGlobalResourceObject("GlobalResources", "AutoPostBackRadioButtonWarning"));
        }
    }
}
...
<table height="100%" width="100%" cellspacing="0" cellpadding="4"
       ...
       style="border-color:#CCDDEF;border-style:None;border-collapse:collapse;" id="ProviderListTable">
    <tr height="1%">

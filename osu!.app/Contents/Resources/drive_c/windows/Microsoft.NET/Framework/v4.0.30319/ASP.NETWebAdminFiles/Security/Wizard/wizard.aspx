...
<form runat="server">
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" >
        ...
        <tr>
            <td height="35" class="callOutWizardHeaderStyle" colspan="2" valign="center" id="HeaderTD"><h1 class="callOutHeaderStyle"><asp:literal runat="server" text="<%$ Resources: SecuritySetupWizard %>"/></h1></td>
        </tr>
        <tr>
